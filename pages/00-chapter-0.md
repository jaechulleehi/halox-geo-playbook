...
## HaloX docs와 함께 읽는 기준

이 장은 용어 설명으로 끝나면 약합니다. HaloX docs의 GEO 리포트 예시, 점수 읽기, AI 검색 모니터링 문서를 함께 보면 GEO가 “새로운 이름”이 아니라 측정/판단/실행 흐름이라는 점이 분명해집니다.

| 개념 | 실제 확인 지점 |
|---|---|
| GEO | AI 답변에서 브랜드가 어떻게 발견/비교/인용되는가 |
| 기준선 | 같은 질문셋을 같은 조건으로 반복 측정할 수 있는가 |
| 리포트 | 점수보다 원인과 다음 액션이 보이는가 |
| 실행 | 콘텐츠/source/기술 중 어디를 먼저 고칠 것인가 |

처음 읽는 독자는 이 장에서 용어를 외우기보다, “우리 브랜드를 어떤 질문으로 물어볼 것인가”를 먼저 남기면 됩니다.
