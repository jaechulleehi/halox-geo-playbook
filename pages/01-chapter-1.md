...
이 장에서는 SEO 키워드를 AI 검색 질문으로 바꾸는 기본 관점을 다룹니다. GEO 최적화 방법은 키워드를 버리는 것이 아니라, 사람들이 실제로 ChatGPT나 Perplexity에 던질 질문과 비교/추천/검증 프롬프트로 확장하는 데서 시작합니다. 이후 [Fan-out 질문 확장과 AI 질문셋](https://wikidocs.net/346343)에서 질문을 더 촘촘하게 펼칩니다.
