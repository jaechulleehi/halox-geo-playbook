...
이 지표를 팀에 공유할 문서로 만들려면 [AI 검색 리포트는 어떤 지표로 읽어야 하나](02-04-ai-search-report.md)를 읽습니다. 출처와 인용을 더 깊게 보려면 [답변 근거(source)와 화면 인용(citation)은 무엇이 다른가](05-01-source-citation-difference.md)로 이어갑니다.
