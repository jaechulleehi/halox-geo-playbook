## AI 검색 모니터링: 브랜드 언급률/source/citation 측정
...
AI 검색 모니터링의 목적은 점수를 확인하는 것이 아니라 다음 작업을 정하는 것입니다. 이 장은 지표를 합치기보다 분리해서 읽고, 콘텐츠 리라이트, 외부 출처 보강, 기술 점검, 메시지 정리 중 무엇을 먼저 해야 하는지 판단합니다.

## 이 장을 읽는 순서

먼저 [02-01. ChatGPT 브랜드 노출 측정과 기준선 기록](https://wikidocs.net/346601)에서 질문군별 브랜드 언급률과 추천 문맥을 봅니다. 다음으로 [02-02. Perplexity SEO와 Google AI Overviews 최적화 비교](https://wikidocs.net/346602)에서 플랫폼별 출처 노출 방식을 나눕니다.

그다음 [02-03. 브랜드 언급률/source/citation 지표 분리](https://wikidocs.net/346603)에서 세 지표의 조합을 해석하고, [02-04. AI 검색 리포트 핵심 지표와 해석 기준](https://wikidocs.net/346604)에서 30일 실행 계획으로 넘깁니다.

## HaloX 리포트로 기준선 남기기

AI 검색 모니터링은 “오늘 우리 브랜드가 나왔다/안 나왔다”를 캡처하는 일이 아닙니다. 같은 질문셋, 같은 모델/지역/언어 조건, 같은 지표 정의로 반복 측정할 수 있어야 기준선이 됩니다.

| 기준선 항목 | 기록할 내용 |
|---|---|
| 질문셋 | 브랜드/비브랜드/비교/구매 검토 질문 구분 |
| 플랫폼 | ChatGPT, Perplexity, Google AI Overviews 등 측정 조건 |
| 지표 | mention/source/citation, AVI, 출처 가시성 |
| 원인 | 경쟁 URL, 외부 출처, 공식 URL 누락 이유 |
| 다음 액션 | 콘텐츠, source, 기술 점검 중 우선순위 |

HaloX docs의 리포트 예시처럼 결과 문장은 “점수가 올랐다”보다 “어떤 질문군에서 왜 달라졌고 다음에 무엇을 할 것인가”로 써야 합니다.

## 다음 흐름

02장은 1주차 기준선 진단의 후반부입니다. 01장에서 질문셋을 만들었다면, 이 장은 같은 질문을 반복 측정해 기준선을 남깁니다. 이후 [03장 Query Fan-out](https://wikidocs.net/346343)에서 약한 질문군을 더 촘촘하게 펼치고, [04장 콘텐츠 구조](https://wikidocs.net/346332)와 [05장 답변 근거/화면 인용/엔티티 전략](https://wikidocs.net/346333)에서 실제 개선으로 넘어갑니다.
