...
![답변 근거와 엔터티 신호 레이어 지도](../assets/images/body-figures/halox-geo-05-chapter-5-source-citation-entity-layer-map-codex-only.png)
...
| 엔터티 메시지 하우스 | 공식명, 한 줄 정의, 카테고리, 대표 기능, 쓰지 말아야 할 표현 | 05-02/05-06 |
