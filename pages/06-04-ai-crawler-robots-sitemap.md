...
![AI crawler 접근성 점검 흐름](../assets/images/body-figures/halox-geo-06-04-ai-crawler-access-route-map.png)
...
```text
점검 URL: /geo-report-example
robots.txt: /resources/ 경로 차단 없음
sitemap: sitemap.xml에 URL 포함
HTTP 상태: 200
문제: PDF 다운로드 랜딩은 열려 있으나 HTML 요약 페이지가 없음
수정: HTML 요약 페이지를 만들고 sitemap에 포함
```

이 예시는 개발팀에 바로 넘길 수 있는 수준으로 적어야 합니다. “크롤링 확인 필요”보다 “어떤 URL이 어디에서 막히는지”가 보여야 합니다.
