...
|---|---|---|---|
| Organization | 회사 소개, 제품 사이트, 뉴스룸, 문의 페이지 | 공식 조직명, 로고, URL, 연락처, 소셜 프로필, 사업 설명 | 브랜드/엔티티를 같은 이름과 설명으로 묶기 위해 |
...
|---|---|---|
| 엔티티 확인 | Organization, Person, ProfilePage | 이름, URL, logo, sameAs, 대표 설명 |
...
**Q. Organization schema만 넣으면 브랜드 엔티티가 잡히나요?**
