...
![메타 정보와 canonical 점검 패널](../assets/images/body-figures/halox-geo-06-08-meta-canonical-snippet-control-panel-codex-only.png)

_title, meta description, canonical, robots meta, snippet은 URL별로 함께 봐야 검색 약속과 AI 인용 후보가 어긋나지 않습니다._
...
직접적인 검색 구조화 신호라기보다 공유/확산 문맥에서 판단 기준으로 봅니다. Slack, 커뮤니티, SNS에서 공유될 때 제목과 설명이 본문과 맞아야 외부 언급과 브랜드 설명이 일관됩니다.
