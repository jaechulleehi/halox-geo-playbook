...
## 뉴스룸을 source 허브로 만드는 30일 순서

뉴스룸 GEO는 보도자료를 더 많이 내는 일이 아니라, AI가 공식 설명과 최신 근거를 찾을 수 있는 허브를 만드는 일입니다.

| 주차 | 실행 | 산출물 |
|---|---|---|
| 1주차 | AI가 회사를 어떻게 설명하는지 측정 | 브랜드/이슈 질문 리포트 |
| 2주차 | 회사 소개/팩트시트/미디어 키트 정리 | 엔티티 기준 문장 |
| 3주차 | 보도자료 첫 문단과 내부 링크 개선 | citation-ready 뉴스룸 |
| 4주차 | 언론/디렉터리/파트너 설명과 대조 | consensus 점검표 |

뉴스룸의 핵심 URL은 Organization schema, Article schema, canonical, 내부 링크가 함께 맞아야 합니다.
...
- 단순 콘텐츠 추가가 아니라 엔티티 일관성 개선 과제를 정했습니다.
