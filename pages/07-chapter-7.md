...
이 장은 [02. GEO 측정 지표와 HaloX 분석 프레임](https://wikidocs.net/346342)을 산업별 실행 전략으로 바꾸는 장입니다. 앞 장에서 지표를 배웠다면, 여기서는 “우리 업종에서는 무엇을 먼저 볼 것인가”를 정합니다.

## 산업별 적용 패키지

이 장의 세부 페이지는 여섯 가지 현장 사례로 확장합니다. 실제 고객명이나 비공개 정보는 넣지 않고, 반복적으로 확인한 운영 패턴만 익명 사례로 정리합니다.
...
전체 사례 흐름은 [산업별 GEO 익명 케이스북](https://wikidocs.net/346381)에서 한 번에 볼 수 있습니다. 이 장은 그 케이스북을 강의와 실무에 바로 적용할 수 있도록 업종별 페이지로 풀어낸 버전입니다.
...
| 사용 장면 | 이 장의 역할 | 산출물 |
|---|---|---|
| 강의 | 업종별 사례 카드로 토론 | 질문맵/측정표/체크리스트 |
| 실무 | 현재 업종의 병목을 진단 | 콘텐츠 갭/source map/기술 점검 |
| 제품 설명 | HaloX 기능을 문제 해결 흐름으로 설명 | AVI/mention/source/citation/URL 추적 리포트 |
| 이북 | 혼자 따라 할 수 있는 케이스 워크북 | 사례표/템플릿/FAQ |
...
1. 업종별 대표 질문을 정한다.
2. 질문 포션과 우선 지표를 고른다.
3. mention/source/citation/co-mention/answer quality를 읽는다.
4. HaloX의 리포트 카드를 해당 의사결정에 연결한다.
5. 콘텐츠/출처/기술/캠페인 실행으로 나눈다.

이 순서를 쓰면 “우리 기능 소개”가 아니라 “실무자가 당장 판단해야 하는 문제를 줄이는 도구”로 설명됩니다.
...
이 장은 앞선 [06. 테크니컬 GEO와 사이트 구조](https://wikidocs.net/346334)의 흐름을 이어받습니다. 세부 페이지를 읽은 뒤에는 [08. 글로벌/영문 GEO 전략](https://wikidocs.net/346336)으로 넘어가거나, 사례 전체를 보려면 [90. 산업별 GEO 익명 케이스북](https://wikidocs.net/346381)을 읽습니다.
