...
좋은 리포트는 공유용 PDF에서 끝나지 않고 회의 안건으로 바뀝니다. 리포트의 각 지표는 담당 팀의 다음 행동과 연결되어야 합니다.

| 리포트 발견 | 회의 질문 | 담당 |
|---|---|---|
| 비브랜드 추천형 mention 낮음 | 카테고리/비교 콘텐츠가 부족한가? | 콘텐츠/SEO |
| source가 오래된 기사에 치우침 | 공식 팩트시트와 뉴스룸이 약한가? | PR/브랜드 |
| citation이 외부 글로만 잡힘 | 대표 URL/canonical/내부 링크가 약한가? | SEO/개발 |
| answer quality 오류 반복 | 제품 설명/FAQ/schema가 최신인가? | 제품/콘텐츠 |
| 경쟁사 co-mention 우세 | 비교 기준과 proof가 부족한가? | 마케팅/세일즈 |
