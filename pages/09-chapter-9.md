...
GEO 대행사, GEO 컨설팅, GEO 도구를 검토할 때 가장 먼저 봐야 할 것은 “AI 검색에 노출시켜드립니다”라는 약속이 아니라 검증 가능한 리포트 구조입니다. 좋은 파트너와 도구는 내 브랜드가 어떤 질문에서 빠지는지, 답변 근거(source)와 화면 인용(citation)이 어디서 끊기는지, 다음 30일 동안 무엇을 고쳐야 하는지 설명해야 합니다.
...
처음 읽는다면 [09-01. GEO 대행사/컨설팅 선택 기준](https://wikidocs.net/346362)부터 읽습니다. 이미 도구나 리포트를 검토 중이라면 [09-02. GEO 도구 비교](https://wikidocs.net/346363)를 먼저 봅니다. 비용과 실행 범위를 정해야 한다면 [09-03. GEO 컨설팅 비용과 실행 범위](https://wikidocs.net/346364)로 이어가면 됩니다.

## 리포트/제안서 검증 체크리스트

GEO 대행사, 컨설팅, 도구를 비교할 때는 기능 수보다 리포트가 실행으로 이어지는지 봐야 합니다.
