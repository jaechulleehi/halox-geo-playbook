...
이 장은 독자가 GEO를 읽고 끝내지 않도록 4주 실행 순서로 정리합니다. 목표는 과정을 운영하는 것이 아니라, 자기 브랜드의 질문 시장을 만들고 baseline을 측정한 뒤 콘텐츠/출처/기술 액션으로 이어지는 실행 리포트를 완성하는 것입니다.

결과물은 지식 노트가 아니라 `GEO 실행 리포트`입니다. 1주차에는 현재 상태를 기록하고, 2주차에는 질문맵과 콘텐츠 갭을 만들고, 3주차에는 콘텐츠와 source/citation 설계를 실행하고, 4주차에는 30일 액션 플랜과 재측정 기준을 확정합니다.
...
- [10-01. 1주차: GEO Baseline 진단](https://wikidocs.net/346365)
...
4주 실행 로드맵에서 HaloX는 기능 소개용 화면이 아니라 분석과 리포트의 기준으로 사용합니다. 1주차에는 질문셋과 AI 브리핑으로 baseline을 잡고, 2주차에는 질문별 콘텐츠 갭을 찾고, 3주차에는 source/citation과 콘텐츠 구조를 연결하고, 4주차에는 [09-05. 월간 GEO 리포트는 어떻게 활용할까](https://wikidocs.net/346398)의 흐름으로 확장합니다.
...
이 장은 앞선 [09. GEO 도구/파트너/리포트 검증](https://wikidocs.net/346337)의 판단 기준을 실제 실행 계획으로 바꿉니다. 4주 실행 로드맵을 마친 뒤에는 [90. 산업별 GEO 익명 케이스북](https://wikidocs.net/346381)을 참고해 업종별로 어떤 질문과 출처를 더 봐야 하는지 확인합니다.
