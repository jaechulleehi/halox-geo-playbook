...
4주 실행 로드맵에서 HaloX는 기능 소개용 화면이 아니라 분석과 리포트의 기준으로 사용합니다. 1주차에는 질문셋과 AI 브리핑으로 기준선을 잡고, 2주차에는 질문별 콘텐츠 갭을 찾고, 3주차에는 답변 근거(source)/화면 인용(citation)과 콘텐츠 구조를 연결하고, 4주차에는 [09-05. 월간 GEO 리포트로 브랜드 가시성을 관리하는 법](https://wikidocs.net/346398)의 흐름으로 확장합니다.
...
이 장은 앞선 [09. GEO 도구/대행사/컨설팅 검증: AI 검색 리포트 읽는 법](https://wikidocs.net/346337)의 판단 기준을 실제 실행 계획으로 바꿉니다. 4주 실행 로드맵을 마친 뒤에는 [90. 산업별 GEO 익명 케이스북](https://wikidocs.net/346381)을 참고해 업종별로 어떤 질문과 출처를 더 봐야 하는지 확인합니다.
