...
[11-01. AI 구매 에이전트 시대의 커머스 검색 변화](https://wikidocs.net/346597)에서는 SEO/SERP, AIO, GPT/Claude/Perplexity 답변 시장이 커머스에서 어떻게 갈라지는지 봅니다. [11-02. AI 고객을 위한 상품 정보 구조화](https://wikidocs.net/346598)에서는 AI 고객이 상품 정보를 어떤 순서로 확인하는지 정리합니다.

[11-03. Product schema와 merchant feed 점검법](https://wikidocs.net/346599)에서는 Product schema와 merchant feed가 무엇을 보완하고 어디서 충돌하는지 봅니다. [11-04. 커머스 GEO 리스크와 2주 점검 체크리스트](https://wikidocs.net/346600)에서는 리스크와 2주 점검 체크리스트로 실제 실행 순서를 만듭니다.
