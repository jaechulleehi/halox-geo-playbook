...
NAP 정리가 끝나면 [05-02 Entity와 브랜드 합의 신호](https://wikidocs.net/346351)를 함께 보면 좋습니다. 여러 채널이 같은 브랜드와 지점을 같은 의미로 가리키는 것이 엔티티 합의 신호의 출발점입니다. HaloX의 [GEO 콘텐츠 구조화 가이드](https://haloxlabs.ai/ko/blog/geo-content-structure)도 지점/서비스 페이지를 정리할 때 참고할 수 있습니다.
