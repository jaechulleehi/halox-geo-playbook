...
<small>90장은 0~12장에서 만든 질문셋, 측정, 콘텐츠, 출처, 기술, 리스크 기준을 산업별 케이스에 맞춰 4주 실행 플랜으로 바꾸는 장이다.</small>
...
이 체크리스트를 통과하지 못하면 케이스는 아직 읽을거리에 가깝습니다. 통과하면 실무자가 바로 가져가 실행할 수 있는 실행 노트에 가까워집니다.
